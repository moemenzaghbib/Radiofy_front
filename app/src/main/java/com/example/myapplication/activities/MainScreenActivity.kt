...
class MainScreenActivity : AppCompatActivity() {
    ...
    val drawerLayout : DrawerLayout = findViewById(R.id.drawerLayout)
        ...
        navView.setNavigationItemSelectedListener {
            when(it.itemId){
                R.id.home_menu_item -> Toast.makeText(applicationContext, " Clicked Home", Toast.LENGTH_SHORT).show()
                R.id.edit_profile_menu_item -> Toast.makeText(applicationContext, " Edit Profile", Toast.LENGTH_SHORT).show()
                R.id.setting_menu_item -> Toast.makeText(applicationContext, " Settings clicked", Toast.LENGTH_SHORT).show()
                R.id.loguout_menu_item -> Toast.makeText(applicationContext, " Logging out", Toast.LENGTH_SHORT).show()
