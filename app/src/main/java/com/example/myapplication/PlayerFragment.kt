...
import com.example.myapplication.collection.CollectionAdapter
...
import com.example.myapplication.dialogs.FindStationDialog
import com.example.myapplication.dialogs.YesNoDialog
import com.example.myapplication.extensions.isActive
import com.example.myapplication.helpers.*
import com.example.myapplication.playback.PlayerController
import com.example.myapplication.playback.PlayerService
import com.example.myapplication.ui.LayoutHolder
...
class PlayerFragment: Fragment(), CoroutineScope,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if (PreferencesHelper.isHouseKeepingNecessary()) {
            if (ImportHelper.convertOldStations(activity as Context))
                layout.toggleImportingStationViews()
