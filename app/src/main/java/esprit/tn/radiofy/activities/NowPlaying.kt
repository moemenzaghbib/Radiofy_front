...
import esprit.tn.radiofy.databinding.FragmentNowPlayingBinding
...
class NowPlaying : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        requireContext().theme.applyStyle(MusicActivity.currentTheme[MusicActivity.themeIndex], true)
