...
object CollectionHelper {
    ...
    fun isNewStation(collection: esprit.tn.radiofy.core.Collection, station: Station): Boolean {
    ...
    /* Checks if station is already in collection */
    fun isNewStation(collection: esprit.tn.radiofy.core.Collection, remoteStationLocation: String): Boolean {
        collection.stations.forEach {
    ...
    fun updateStation(context: Context, collection: esprit.tn.radiofy.core.Collection, station: Station): esprit.tn.radiofy.core.Collection {
        var updatedCollection: esprit.tn.radiofy.core.Collection = collection
    ...
    fun addStation(context: Context, collection: esprit.tn.radiofy.core.Collection, newStation: Station): esprit.tn.radiofy.core.Collection {
        // check validity
    ...
    fun setStationImageWithRemoteLocation(context: Context, collection: esprit.tn.radiofy.core.Collection, tempImageFileUri: String, remoteFileLocation: String, imageManuallySet: Boolean = false): esprit.tn.radiofy.core.Collection {
    ...
    /* Sets station image - determines station by remote image file location */
    fun setStationImageWithStationUuid(context: Context, collection: esprit.tn.radiofy.core.Collection, tempImageFileUri: String, stationUuid: String, imageManuallySet: Boolean = false): esprit.tn.radiofy.core.Collection {
        collection.stations.forEach { station ->
    ...
    fun getStation(collection: esprit.tn.radiofy.core.Collection, stationUuid: String): Station {
        collection.stations.forEach { station ->
                if (station.uuid == stationUuid) {
                    return station
                }
    ...
    fun getStationWithStreamUri(collection: esprit.tn.radiofy.core.Collection, streamUri: String): Station {
        collection.stations.forEach { station ->
    ...
    fun getNextStation(collection: esprit.tn.radiofy.core.Collection, stationUuid: String): Station {
    ...
    fun getPreviousStation(collection: esprit.tn.radiofy.core.Collection, stationUuid: String): Station {
        val currentStationPosition: Int = getStationPosition(collection, stationUuid)
        LogHelper.d(TAG, "Number of stations: ${collection.stations.size} | current position: $currentStationPosition") // todo remove
        if (collection.stations.isEmpty() || currentStationPosition == -1) {
            return Station()
    ...
    fun getStationPosition(collection: esprit.tn.radiofy.core.Collection, stationUuid: String): Int {
    ...
    fun getStationPositionFromRadioBrowserStationUuid(collection: esprit.tn.radiofy.core.Collection, radioBrowserStationUuid: String): Int {
        collection.stations.forEachIndexed { stationId, station ->
    ...
    fun getStationName(collection: esprit.tn.radiofy.core.Collection, stationUuid: String): String {
        collection.stations.forEach { station ->
            if (station.uuid == stationUuid) {
                return station.name
            }
    ...
    fun savePlaybackState(context: Context, collection: esprit.tn.radiofy.core.Collection, station: Station, playbackState: Int): esprit.tn.radiofy.core.Collection {
    ...
    fun saveCollection (context: Context, collection: esprit.tn.radiofy.core.Collection, async: Boolean = true): Date {
    ...
    fun exportCollectionM3u(context: Context, collection: esprit.tn.radiofy.core.Collection) {
    ...
    fun createM3uString(collection: esprit.tn.radiofy.core.Collection): String {
    ...
    fun sortCollection(collection: esprit.tn.radiofy.core.Collection): esprit.tn.radiofy.core.Collection {
