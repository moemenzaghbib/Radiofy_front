...
import esprit.tn.radiofy.dialogs.FindStationDialog
import kotlinx.coroutines.*
import esprit.tn.radiofy.Keys
import esprit.tn.radiofy.collection.CollectionAdapter
import esprit.tn.radiofy.collection.CollectionViewModel
import esprit.tn.radiofy.core.Station
import esprit.tn.radiofy.dialogs.YesNoDialog
import esprit.tn.radiofy.extensions.isActive
import esprit.tn.radiofy.helpers.*
import esprit.tn.radiofy.playback.PlayerController
import esprit.tn.radiofy.playback.PlayerService
import esprit.tn.radiofy.ui.LayoutHolder
import esprit.tn.radiofy.ui.PlayerState
import java.util.*
...
class PlayerFragment: Fragment(), CoroutineScope,
    ...
    private fun observeCollectionViewModel() {
        collectionViewModel.collectionLiveData.observe(this, Observer<esprit.tn.radiofy.core.Collection> { it ->
            // update collection
            collection = it
