...
package esprit.tn.radiofy.collection
...
class CollectionAdapter(private val context: Context, private val collectionAdapterListener: CollectionAdapterListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), UpdateHelper.UpdateHelperListener {
    ...
    private var collection: esprit.tn.radiofy.core.Collection = esprit.tn.radiofy.core.Collection()
...
//                        stationViewHolder.stationUriEditView.isGone = true
    ...
    override fun onStationUpdated(collection: esprit.tn.radiofy.core.Collection, positionPriorUpdate: Int, positionAfterUpdate: Int) {
...
//                                stationViewHolder.saveButton.isEnabled = true
    ...
    private fun updateRecyclerView(oldCollection: esprit.tn.radiofy.core.Collection, newCollection: esprit.tn.radiofy.core.Collection) {
        collection = newCollection
    ...
    private fun observeCollectionViewModel(owner: LifecycleOwner) {
        collectionViewModel.collectionLiveData.observe(owner, Observer<esprit.tn.radiofy.core.Collection> { newCollection ->
...
//        val saveButton: MaterialButton = stationCardLayout.findViewById(R.id.save_button)
     ...
     */
    private inner class CollectionDiffCallback(val oldCollection: esprit.tn.radiofy.core.Collection, val newCollection: esprit.tn.radiofy.core.Collection): DiffUtil.Callback() {
