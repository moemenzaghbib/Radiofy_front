...
class CollectionViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val collectionLiveData: MutableLiveData<esprit.tn.radiofy.core.Collection> = MutableLiveData<esprit.tn.radiofy.core.Collection>()
    ...
    private fun loadCollection(context: Context) {
        ...
        viewModelScope.launch {
            ...
            val collection: esprit.tn.radiofy.core.Collection = FileHelper.readCollectionSuspended(getApplication())
