...
import esprit.tn.radiofy.helpers.CollectionHelper
...
class CollectionProvider {
    ...
    fun retrieveMedia(context: Context, collection: esprit.tn.radiofy.core.Collection, stationListProviderCallback: CollectionProviderCallback) {
