...
object Keys {
    ...
    // intent actions
    const val ACTION_SHOW_PLAYER: String = "esprit.tn.radiofy.action.SHOW_PLAYER"
    const val ACTION_START_PLAYER_SERVICE: String = "esprit.tn.radiofy.action.START_PLAYER_SERVICE"
    const val ACTION_COLLECTION_CHANGED: String = "esprit.tn.radiofy.action.COLLECTION_CHANGED"
    const val ACTION_START: String = "esprit.tn.radiofy.action.START"
    const val ACTION_STOP: String = "esprit.tn.radiofy.action.STOP"
    ...
    // locations
    const val LOCATION_DEFAULT_STATION_IMAGE: String = "android.resource://esprit.tn.radiofy/drawable/ic_default_station_image_24dp"
