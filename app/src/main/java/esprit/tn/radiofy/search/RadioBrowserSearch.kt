...
package esprit.tn.radiofy.search
...
import esprit.tn.radiofy.helpers.NetworkHelper
    ...
    fun searchStation(context: Context, query: String, searchType: Int) {
        ...
        val stringRequest = object: JsonArrayRequest(Method.GET, requestUrl, null, responseListener, errorListener) {
            ...
            override fun getHeaders(): Map<String, String> {
                ...
                params["User-Agent"] = "$Keys.APPLICATION_NAME ${esprit.tn.radiofy.BuildConfig.VERSION_NAME}"
                return params
            }
        }
