...
package esprit.tn.radiofy.playback
...
import esprit.tn.radiofy.collection.CollectionProvider
...
//                if (recentStation != null) mediaItems.add(recentStation)
    ...
    private fun loadCollection(context: Context) {
        ...
        CoroutineScope(Main).launch {
            ...
            val deferred: Deferred<esprit.tn.radiofy.core.Collection> = async(Dispatchers.Default) { FileHelper.readCollectionSuspended(context) }
